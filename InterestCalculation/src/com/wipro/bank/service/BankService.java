...
public class BankService {
	public boolean validationData(float principal,int tenure,int age,String gender)
	{
		try
		{
			if(principal<500)
			...
			if(age<1 || age>100)
				throw new BankValidationException("1 to 100 only");
		}
	...
	{
		boolean validateFlag=validationData(principal,tenure,age,gender);
